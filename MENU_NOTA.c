...
void menu(int escolha, int continuar, float notaExerciciograuA, float notaTrabalhograuA, float notaProvagrauA, float notaExerciciosgrauB, float notaTrabalhograuB, float notaProvagrauB, float notaGrauAfinal, float notaGrauBFinal, float notaGrauc, float notaFinal, char substituicao) {
    ...
    switch (escolha) {
        ...
        //Opção - Inserir nota EXERCICIOS (GA)
        case 2:
        ...
        //Opção - Inserir nota TRABALHO (GA)
        case 3:
        ...
        //Opção - Inserir nota EXERCICIOS (GB)
        case 5:
        ...
        //Opção - Inserir nota TRABALHO (GB)
        case 6:
        ...
        //Opção - Inserir Substituição de Grau
        case 11:
...
int main() {
    ...
    float notaExerciciograuA;
    float notaTrabalhograuA; 
    float notaProvagrauA; 
    float notaGrauAfinal; 
    float notaExerciciosgrauB; 
    float notaTrabalhograuB; 
    float notaProvagrauB; 
    float notaGrauBFinal; 
    float notaFinal; 
    float notaGrauc;
    char substituicao;
